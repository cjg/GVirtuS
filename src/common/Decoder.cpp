...
int Decoder::Decode(char value_in) { return Value(value_in); }

int Decoder::Decode(const char *code_in, const int length_in,
                    char *plaintext_out) {
...
int Decoder::Block(const char *code_in, const int length_in,
                   char *plaintext_out) {
