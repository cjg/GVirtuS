...
${OBJECTDIR}/Subprocess.o: nbproject/Makefile-${CND_CONF}.mk Subprocess.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Subprocess.o Subprocess.cpp
...
${OBJECTDIR}/VMSocketCommunicator.o: nbproject/Makefile-${CND_CONF}.mk VMSocketCommunicator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/VMSocketCommunicator.o VMSocketCommunicator.cpp
