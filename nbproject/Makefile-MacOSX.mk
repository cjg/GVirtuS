...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-MacOSX.mk dist/MacOSX/GNU-Linux-x86/libEchoesUtil.so

dist/MacOSX/GNU-Linux-x86/libEchoesUtil.so: ${OBJECTFILES}
...
${OBJECTDIR}/Subprocess.o: nbproject/Makefile-${CND_CONF}.mk Subprocess.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/Subprocess.o Subprocess.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/MacOSX
	${RM} dist/MacOSX/GNU-Linux-x86/libEchoesUtil.so
