...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/libEchoesUtils.so

dist/Debug/GNU-Linux-x86/libEchoesUtils.so: ${OBJECTFILES}
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/libEchoesUtils.so
